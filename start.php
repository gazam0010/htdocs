...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li id="mysBtn"><a href="#"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
...
<button id="mysBtn">Open Modal</button>
...
<div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <label>Code</label>
                <input type="password" name="code" class="form-control" value="">
            </div>
