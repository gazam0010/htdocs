...
<body>
    ...
    <h3 align="center"><strong><font color="green">COVID 19 Information System (CIS) Administrator Panel</font></strong></h3>
   <hr color="black">
   <h5 align="center">Request for Password reset</h5>
        <ul>
            <p align="left">
                <font size="2">
    ...
    <br><br>
        <hr>
        <footer align="center">
        <font  color="grey">Designed and Developed by Gulfarogh Azam (18CAB105)</font>
        </footer>
</body>
