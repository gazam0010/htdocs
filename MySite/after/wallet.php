...
<head>
    ...
    <style>
        #txn tr:nth-child(even) {
            background-color: #eee;
        }

        #txn tr:nth-child(odd) {
...
<body>
    <div class="header w3-card">
        <h1 align="center">WALLET<br></h1>
    </div>
    <br>
    <a href="<?php echo $pp; ?>">
        <div class="back-button"><img src="../img/back-button.png" width="42.5" height="37.5" /></div>
    </a>
    <h2 align="center">
        <font size="5">Hello, <strong><?php echo $_SESSION['a3da707b651c79ecc39a4986516180b2_fname']; ?></strong></font>
    </h2>
    ...
    <div class="body w3-card-4"">
        ...
        <div class="backg-profile w3-card">
            <div class="a"><a style="text-decoration: none" href="#" id="myBtn">
                    <font size="1.5">TRANSACTIONS&nbsp;&nbsp;</font>
                </a></div>
            <div class="backg-profile-data">
                ...
                <table>
                    <tr>
                        <td colspan="2" class="w3-tag"><strong>Redeem Gift Card </strong></td>
                    </tr>
                    ...
                    <tr>
                        <th align="right">
                            <form method="post" action="">Pin: &nbsp;
                                <input type="text" placeholder="XXXX-XXXX-XXXX" maxlength="14" id="tbNum" name="pin" onkeyup="addHyphen(this)" required>
                        </th>
                        <th align="left">&nbsp;
                            <input type="submit" class="w3-button w3-green w3-small" name="redeem" value="Redeem"> </form>
                        </th>
        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    $txn_query = "SELECT * FROM wallet_transactions WHERE id = '$id' ORDER BY date_time DESC";
                    $output = mysqli_query($db, $txn_query);

                    if ($output->num_rows > 0) {

                        echo '<body onload=goto("#table-output")> 
                        <table border="1px" id="txn" width="90%" style="margin: 5%;">
                <tr>
                    ...
                    <th>Usage</th>
                        ...
                        while ($txn = $output->fetch_assoc()) {
                            ...
                            echo '</td>';
                            echo '<td>';
                            echo (date("d-m-Y h:i:s a", $txn['date_time'] + 16200));
                            echo '</td>';
                            echo '<td>';
                            if ($txn['type'] == 'Credit') {
                                $txn_type = '<font color="green">Credit</font>';
                            } else {
                                $txn_type = '<font color="red">Debit</font>';
                            }
                            echo $txn_type;
                            echo '</td>';
                            echo '<td>';
                            echo $txn['usage_place'];
                            echo '</td>';
                            echo '</tr>';
                        }
                        echo '</table>';
