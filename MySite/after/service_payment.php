        ...
        <?php
            ...
            <span style="font-size: 20px; line-height:1.6;">
                ...
                <div class="pp">
                    ...
                    <form method="post" action="service_order_pay.php">
                    <h4><strong>Service Name: </strong><?php echo $serv_name . ' (' . $order_name . ')'; ?></h4>

                    <input type="hidden" value="<?php echo $serv_name; ?>" name="service_name">
                    <input type="hidden" value="<?php echo $order_name; ?>" name="order_name">
                    <input type="hidden" name="service_page_name" value="<?php echo $service_page_name; ?>">
                    <input type="hidden" name="service_page_link" value="<?php echo $service_page_link; ?>">

                    <h4><strong>Order Cost: </strong><?php echo 'Rs. ' . $order_charge; ?></h4><br>

                    <input type="hidden" value="<?php echo $order_charge; ?>" name="order_charge">
                    <input type="hidden" value="<?php echo $serv_charge; ?>" name="service_charge">
                    <input type="hidden" value="<?php echo $serv_charge_reason; ?>" name="service_charge_reason">
                    ...
                    if($serv_name != "Withdraw Fund") {
                                    echo '<h5>&nbsp;&nbsp;&nbsp;<input type="radio" name="payment_mode" value="WA" required> Wallet (₹'.$balance.')</h5>';
                                    echo '<h5>&nbsp;&nbsp;&nbsp;<input type="radio" name="payment_mode" value="CC" required> Credit Card</h5>';
                                    echo '<h5>&nbsp;&nbsp;&nbsp;<input type="radio" name="payment_mode" value="DC" required> Debit Card</h5>';
                                    echo '<h5>&nbsp;&nbsp;&nbsp;<input type="radio" name="payment_mode" value="UPI" required> UPI</h5>';
                                }
                    ...
                    if($serv_name === "Withdraw Fund") {
                        ...
                        echo '<h5>&nbsp;&nbsp;&nbsp;<input type="radio" name="payment_mode" value="DC" required> Debit Card</h5>';
                        echo '<h5>&nbsp;&nbsp;&nbsp;<input type="radio" name="payment_mode" value="UPI" required> UPI</h5>';
                        echo '<font size="2px" color="red">Payment using wallet is not available in Fund Withdrawal.</font>';
                    }
                    ?>
                    <br><br>

                    <input type="hidden" value="<?php echo $total_cost; ?>" name="amount_to_be_debited">
                    <input type="submit" value="Make payment" name="place_service_order" class="w3-green w3-button w3-round w3-left w3-small">
                    </form>
                </div>
