...
<body>
    ...
    <div class="w3-container w3-padding-64">
        <div class="main-cont-serv w3-card">
            <p align="left">
                <font size="2px" color="grey"><a href="services_after.php">Services</a> / Medicines & Health</font>
            </p>
                        ...
                        <tr>
                            <td align="center">
                                <div class="w3-card">
                                    ...
                                    <img src="../img/med1.jfif" /><br><br>
                                    Medicine A
                                    <br><br>
                                    <form method="post" action="service_payment.php">
                                    <input type="hidden" name="service_page_name" value="Medicines & Health">
                                    <input type="hidden" name="service_page_link" value="http://localhost/MySite/after/medicines_health.php">
                                    <input type="hidden" name="service_name" value="Medicines">
                                    <input type="hidden" name="order_name" value="Medicine A">
                                    <input type="hidden" name="order_charge" value="200">
                                    <input type="hidden" name="service_charge_reason" value="Delivery">
                                    <input type="hidden" name="service_charge" value="100">
                                    <input type="submit" value="Buy Now" name="serv_order" class="w3-button w3-green w3-round"><br><br>
                                    </form>
                                </div>
                            </td>
                            <td align="center">
                                <div class="w3-card">
                                    ...
                                    <input type="hidden" name="service_page_link" value="http://localhost/MySite/after/medicines_health.php">
                                    <input type="hidden" name="service_name" value="Medicines">
                                    <input type="hidden" name="order_name" value="Medicine B">
                                    <input type="hidden" name="order_charge" value="150">
                                    <input type="hidden" name="service_charge_reason" value="Delivery">
                                    <input type="hidden" name="service_charge" value="100">
                                    <input type="submit" value="Buy Now" name="serv_order" class="w3-button w3-green w3-round"><br><br>
                                    </form>
                        ...
                        <tr>
                            <td align="center">
                                <div class="w3-card">
                                    ...
                                    <input type="hidden" name="service_page_link" value="http://localhost/MySite/after/medicines_health.php">
                                    <input type="hidden" name="service_name" value="Medicines">
                                    <input type="hidden" name="order_name" value="Medicine C">
                                    <input type="hidden" name="order_charge" value="250">
                                    <input type="hidden" name="service_charge_reason" value="Delivery">
                                    <input type="hidden" name="service_charge" value="100">
                                    <input type="submit" value="Buy Now" name="serv_order" class="w3-button w3-green w3-round"><br><br>
                                    </form>
                            ...
                            <td align="center">
                                <div class="w3-card">
                                    ...
                                    <input type="hidden" name="service_name" value="Medicines">
                                    <input type="hidden" name="order_name" value="Medicine C">
                                    <input type="hidden" name="order_charge" value="550">
                                    <input type="hidden" name="service_charge_reason" value="Delivery">
                                    <input type="hidden" name="service_charge" value="100">
                                    <input type="submit" value="Buy Now" name="serv_order" class="w3-button w3-green w3-round"><br><br>
                                    </form>
