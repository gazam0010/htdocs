...
<div id="process">
<br><br><br><br>
<h4 align="center">Please wait your payment is in process.</h4>
</div>
<div id="loader"></div>
...
<div class="bordr">
    ...
    <h3>We thank you for your precious support<br>We have <strong>successfully</strong> received your donation<br>
        Hoping you'd donate more.<br><br><u>Here is your transaction info:</u><br><br>
        Transaction ID: <strong><?php echo $_SESSION['txn']; ?></strong><br><br>
    Amount: <?php echo $_SESSION['amount']; ?> INR</h3>
