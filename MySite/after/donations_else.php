...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    $query="SELECT * FROM donate_else WHERE id='$id' GROUP BY date DESC";
    ...
    while($row = $result->fetch_assoc()) {
        ...
        if($status != 'Cancelled'){
        echo '<td><form onsubmit="return submitForm(this);" action="" method="post"><input type="hidden" value="'.$od_id.'" name="od_id"><input type="submit" value="Cancel Order" name="don_can"></form></td>';
        }
        if($status == 'Cancelled'){
        echo '<td><form action="" method="post">'
            . '<input type="hidden" value="'.$od_id.'" name="od_id"><input type="submit" value="Delete Cancelled Order" name="don_del"></form></td>';
        }
        echo '</tr>';
        echo '</table>';
        echo '</h12>';
...
<script>
    function submitForm() {
  return confirm('Do you really want to cancel the order?');
}
</script>
</body>
<?php
