...
df_train = pd.read_csv("C:/xampp/htdocs/HMS/diabetes_train_preprocessed.csv")

# Load the preprocessed testing dataset
df_test = pd.read_csv("C:/xampp/htdocs/HMS/diabetes_test_preprocessed.csv")
